      ...
      <div class="row justify-content-center">
         <div class="col-md-8">
            <div class="values__inner">
               <p>
                  Компания Support Partners успешно занимается поиском руководителей высшего (executive search) и
                  среднего звена для российского бизнеса, иностранных компаний и государственных корпораций. Наши
                  клиенты работают в различных отраслях экономики, от энергетики и нефтегазового комплекса до
                  производства и продажи продуктов питания, от розничной торговли до сектора высоких технологий.
               </p>
               <p>
                  Путем быстрого и качественного поиска руководителей мы позволяем нашим клиентам решать их
                  бизнес-задачи и добиваться поставленных целей.
               </p>
               <p>Каждый из наших партнеров и консультантов — прежде всего действующий специалист по executive search,
                  успешно работающий в этой отрасли не менее 10 лет. Мы глубоко знаем наши отрасли специализации и
                  бизнес наших клиентов, что позволяет действовать быстрее и добиваться лучшего результата для клиентов.
               </p>
            </div>
         </div>
      </div>
