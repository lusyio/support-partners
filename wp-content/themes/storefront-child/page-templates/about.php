            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="specialists__card">
                        ...
                        <div class="specialists__card-descr">Управляющий партнёр, <br> Руководитель практики <br>
                            Стратегические
                            сессии
                        </div>
                        <a class="specialists__card-link" href="#">Подробнее</a>
                ...
                <div class="col-md-3">
                    <a href="#" class="specialists__card specialists__card_empty">
                        ...
                        <div class="specialists__card-imgwrap">
                            <img class="specialists__card-img" src="/wp-content/themes/storefront-child/svg/cup.svg"
                                 alt="">
                        </div>
                        <svg class="icon">
