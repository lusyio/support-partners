      ...
      <div class="row align-items-center">
         <div class="col-md-6">
            <div class="main-screen__inner">
               ...
               <div class="main-screen__descr">Масштабная конференция о создании <br> сильных команд</div>
               <div>
         ...
         <div class="col-md-4">
            <div class="team__item team__item_small team__item_white">
               <div class="team__item-box">
                  ...
                  <div class="team__item-descr team__item-descr_small">Найти менеджера или <br> подать резюме </div>
